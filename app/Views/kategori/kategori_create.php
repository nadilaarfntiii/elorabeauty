...
<div class="container-fluid">
    ...
    <form action="/kategori/save" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="id_kategori" name="id_kategori" required placeholder="Masukkan ID Kategori">
        </div>

        <div class="form-group">
            <label for="nm_kategori">Nama Kategori</label>
            <input type="text" class="form-control" id="nm_kategori" name="nm_kategori" required placeholder="Masukkan Nama Kategori">
        </div>

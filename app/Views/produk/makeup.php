...
<div class="container-fluid">
    ...
    <h1 class="text-center mb-4" style="color: #b90056;">Makeup Products</h1>

    <div class="d-flex justify-content-end mb-4">
        <a href="<?= base_url('/produk/product_create?kategori=Makeup') ?>"
        class="btn btn-pink">+ Tambah Produk</a>
    </div>

    <div class="order-info" style="color: #b90056;">
        <p>Total Produk: <?= count($makeup); ?> makeup</p>
    </div>
    ...
    <div class="table-wrapper">
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="16" class="text-center">Tidak ada produk makeup yang tersedia.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>

...
<div class="container-fluid">
    ...
    <h1 class="text-center mb-4" style="color: #b90056;">Hair & Body Products</h1>

    <div class="d-flex justify-content-end mb-4">
        <a href="<?= base_url('/produk/product_create?kategori=Hairnbody') ?>"
        class="btn btn-pink">+ Tambah Produk</a>
    </div>

    <div class="order-info" style="color: #b90056;">
        <p>Total Produk: <?= count($hairnbody); ?> hairnbody</p>
    </div>
    ...
    <div class="table-wrapper">
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                <?php if (!empty($hairnbody)): ?>
                    <?php foreach($hairnbody as $pr): ?>
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-center align-items-center gap-2">
                                    <a href="<?= base_url('/produk/product_update' . esc($pr['id_product'])); ?>" class="btn btn-pink btn-sm">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="<?= base_url('/product/arsip/' . esc($pr['id_product'])); ?>" class="btn btn-pink btn-sm">
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="16" class="text-center">Tidak ada produk skincare yang tersedia.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>

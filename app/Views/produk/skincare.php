...
<div class="container-fluid">
    ...
    <h1 class="text-center mb-4" style="color: #b90056;">Skincare Products</h1>

    <div class="d-flex justify-content-end mb-4">
        <a href="<?= base_url('/produk/product_create?kategori=Skincare') ?>"
        class="btn btn-pink">+ Tambah Produk</a>
    </div>

    <div class="order-info" style="color: #b90056;">
        <p>Total Produk: <?= count($skincare); ?> skincare</p>
    </div>
